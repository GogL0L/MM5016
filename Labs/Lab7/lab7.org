...
A = [[5, -2, 3], [-3, 9, 1], [2, -1, -7]]
b = [[-1], [2], [3]]
result = jacobi_method(A,b, debug= False)
print("result:", result)
print("b:", b)
print("b_aprox:", matrix_multiply(A,result))
#+end_src

#+RESULTS:
: result: [[0.18632557879118725], [0.33116049382716045], [-0.42264908597183726]]
: b: [[-1], [2], [3]]
: b_aprox: [[-0.9986403516138964], [1.9988186220990454], [3.0000342655580745]]
...
#+begin_src python :results output :session
def gradient_descent(function, gradient_function, tolerance, learning_step_size,
                     vector_approximation = [[0],[0]],
    ...
    if norm(gradient) <= tolerance:
        ...
        return gradient_descent(function, gradient, tolerance,
                                learning_step_size, new_approximation,
                                iteration+1)
#+end_src
