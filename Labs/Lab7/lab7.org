...
#+begin_src python :results output :session
## Iterate function
def iterate(function, root_approximates, tolerance, metric, next_values_function,
    ...
    satisfies_tolerance = metric(function(newest_root_approximate)) <= tolerance
...
#+begin_src python :results output :session
def jacobi_next_value_function(D, D_inverse, L, U, X, b):
    """ Given the 
#+end_src
