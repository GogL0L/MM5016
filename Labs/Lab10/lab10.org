...
#+RESULTS:
: problem_1_analytic_function: <function <lambda> at 0x7f0665d1b820>
...
problem_1a_f_linearly_interpolated = linear_interpolation(problem_1a_data_set)
...
problem_1c_f_linearly_interpolated = linear_interpolation(problem_1c_data_set)
...
## Problem 1d
def problem_1d():
    f_analytic = problem_1c_f_linearly_interpolated
    f_interpolated = problem_1a_f_linearly_interpolated
    print("y(1.052) analytic:", f_analytic(1.052))
    print("y(1.052) approximated:", f_interpolated(1.052))
...
#+RESULTS:
: y(1.052) analytic: -0.9099721532805549
: y(1.052) approximated: -0.9961051669699956
: y(1.555) analytic: -0.6333668182903549
: y(1.555) approximated: -0.7094723352327039
: y(1.978) analytic: -0.5042298822557729
: y(1.978) approximated: -0.5854187864185804
