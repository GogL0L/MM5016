...
def problem_1b():
    ...
    x = np.linspace(1, 2, int(1 / 0.05))
    y = list(map(f,x))
    data_set = list(zip(x,y))
    f_linearly_interpolated = linear_interpolation(data_set)

    f_analytic = lambda t: - 1 / t
    print("y(1.052) analytic:", f_analytic(1.052))
    print("y(1.052) approximated:", f_linearly_interpolated(1.052))

    print("y(1.555) analytic:", f_analytic(1.555))
    print("y(1.555) approximated:", f_linearly_interpolated(1.555))

    print("y(1.978) analytic:", f_analytic(1.978))
    print("y(1.978) approximated:", f_linearly_interpolated(1.978))
