...
\begin{align*}
 &  10 \cdot \sqrt{0.0293} \leq \frac{\sqrt{0.0002}}{\sqrt{1.49}} \\
\iff & \sqrt{100 \cdot 0.0293} \leq \sqrt{\frac{0.0002}{1.49} } \\
\iff & \sqrt{2.93} \leq \sqrt{\frac{1}{10^{4}} \cdot \frac{2}{1.49}} \\
\iff & \sqrt{2.93} \leq \frac{1}{10 ^2} \cdot \sqrt{\frac{2}{1.49}}
.
\end{align*}
